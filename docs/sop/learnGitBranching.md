...
| `1 2 ` | `git commit //生成C2节点 git commit //生成C3节点 ` |
| ------ | -------------------------------------------------- |
|        |                                                    |
...
| `1 2 3 ` | `git branch bugFix   //生成分支bugFix git checkout bugFix //切换到bugFix分支上 // git checkout -b bugFix ` |
| -------- | ------------------------------------------------------------ |
|          |                                                              |
...
| `1 2 3 4 5 ` | `git checkout -b bugFix //创建并切换分支bugFix git commit             //在bugFix分支增加C2节点 git checkout main      //切换到main上 git commit             //在main分支增加C3节点 git merge bugFix       //将bugFix分支的内容合并到main上 ` |
| ------------ | ------------------------------------------------------------ |
|              |                                                              |
...
| `1 2 3 4 5 6 ` | `git checkout -b bugFix //创建并切换分支bugFix git commit             //在bugFix上增加C2节点 git checkout main      //切换到main上 git commit             //在main上增加C3节点 git checkout bugFix    //切换到bugFix分支上 git rebase main        //将bugFix分支上的内容合并到main上 ` |
| -------------- | ------------------------------------------------------------ |
|                |                                                              |
...
| `1 ` | `git branch -f main HEAD~3 //这条命令会将main分支强制指向HEAD的第3级父提交。 ` |
| ---- | ------------------------------------------------------------ |
|      |                                                              |
...
| `1 2 3 4 5 6 ` | `// 三条命令的顺序不重要 $ git branch -f main C6 $ git checkout HEAD^   // 或者git checkout C1 $ git branch -f bugFix HEAD^ ` |
| -------------- | ------------------------------------------------------------ |
|                |                                                              |
...
| `1 ` | `git reset HEAD~  // 撤销当前提交(即向上移动分支) ` |
| ---- | --------------------------------------------------- |
|      |                                                     |
...
| `1 2 3 ` | `git reset HEAD^     //撤销本地分支用reset  git checkout pushed   git revert HEAD     //撤销远程分支用revert ` |
| -------- | ------------------------------------------------------------ |
|          |                                                              |
...
[![img](images/v2-ec270bffdba29fdb8bfdc8173e5a6be6_720w.jpg)](https://guocfu.github.io/p/images/v2-ec270bffdba29fdb8bfdc8173e5a6be6_720w.jpg)img
...
[![img](images/v2-e3414a7c0cf1e424a92c4701edccc283_720w.jpg)](https://guocfu.github.io/p/images/v2-e3414a7c0cf1e424a92c4701edccc283_720w.jpg)img
...
[![image-20250727120923869](images/image-20250727120923869.png)](https://guocfu.github.io/p/images/image-20250727120923869.png)image-20250727120923869



| `1 2 3 ` | `git commit  git checkout o/main  git commit ` |
| -------- | ---------------------------------------------- |
|          |                                                |
...
[![image-20250727121524697](images/image-20250727121524697.png)](https://guocfu.github.io/p/images/image-20250727121524697.png)image-20250727121524697
...
![image-20250727141242445](images/image-20250727141242445.png)
...
![image-20250727141659192](images/image-20250727141659192.png)

| `1 2 3 4 5 ` | `git clone   //local branch "master" set to track remote branch "o/master"  git fakeTeamwork main 2 // 模拟环境虚构的命令, 在远程仓库的main分支上做n次提交。 git commit  git fetch  git merge o/main // 最后两行可以直接用git pull替换 ` |
| ------------ | ------------------------------------------------------------ |
|              |                                                              |
...
![image-20250727142458176](images/image-20250727142458176.png)

| `1 2 3 ` | `git commit git commit git push` |
| -------- | -------------------------------- |
|          |                                  |